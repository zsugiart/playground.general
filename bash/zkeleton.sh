...
function helloworld() {
	msg=$1
	if [ "$msg" == "" ]; then log_error "param1:msg is mandatory"; return 1; fi
	log_info "running helloworld() function with param: $msg"
}
